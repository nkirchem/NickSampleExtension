...
import { AsyncExecutionResult, createComponentConnector, usePropertyBag } from "@microsoft/azureportal-reactview/DataManagement";
...
export type IDataTest4Context = {
    ...
    reloadSubscriptions(): Promise<AsyncExecutionResult<Subscription[], Error>>;
...
const DataTest4Context = React.createContext<IDataTest4Context>({ dispatch: () => {}, reloadSubscriptions: async () => ({ result: [] }) });
