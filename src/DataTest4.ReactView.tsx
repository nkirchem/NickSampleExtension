...
const SubscriptionCommandBarWrapper = connectDataTest4Component.connectContextProps(
...
const NavHeaderWrapper = connectDataTest4Component
...
const SubscriptionDetailsWrapper = connectDataTest4Component.connectContextProps(
...
const SubscriptionListWrapper = connectDataTest4Component.connect(
  context => ({
