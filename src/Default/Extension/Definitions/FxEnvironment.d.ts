...
type DeepReadonly<T> = {
    readonly [P in keyof T]: T[P] extends boolean | number | string | Date | Function | RegExp | undefined | null ? T[P] : DeepReadonly<T[P]>;
}

declare const enum ExtensionNames {
    HubsExtension = "HubsExtension",
    Microsoft_AAD_IAM = "Microsoft_AAD_IAM",
    ...
    Microsoft_Azure_PIM = "Microsoft_Azure_PIM",
    Microsoft_Azure_PIMCommon = "Microsoft_Azure_PIMCommon",
    Microsoft_Azure_PortalDashboard = "Microsoft_Azure_PortalDashboard",
    ...
    Microsoft_Intune_DeviceConfig = "Microsoft_Intune_DeviceConfig",
    Microsoft_Intune_DeviceSettings = "Microsoft_Intune_DeviceSettings",
    Microsoft_Intune_MTM = "Microsoft_Intune_MTM",
    WebsitesExtension = "WebsitesExtension",
    Microsoft_AAD_Connect_Provisioning = "Microsoft_AAD_Connect_Provisioning",
    Microsoft_AAD_RegisteredApps = "Microsoft_AAD_RegisteredApps",
    Microsoft_AAD_ConditionalAccess = "Microsoft_AAD_ConditionalAccess",
    Microsoft_Azure_Capacity = "Microsoft_Azure_Capacity",
}
...
// The TypeScript ES5 typings are missing the finally() method on native promises.
// If the typing is fixed or the project is changed to target ES6 this declaration can be deleted.
// This definition exactly matches the TypeScript lib definition of Promise finally including support for strict null checks.
interface Promise<T> {
    /**
