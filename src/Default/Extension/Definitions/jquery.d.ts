...
interface JQueryStatic {
    ...
    ****/
    ...
    /*******
     EFFECTS
    ********/
    fx: { tick: () => void; /** @deprecated interval property is now ignored on all browser */ interval: number; stop: () => void; speeds: { slow: number; fast: number; }; off: boolean; step: any; };
    ...
    **********/
    ...
    /** @deprecated Prefer native browser JSON.parse() instead */
...
interface JQuery {
    ...
    ***********/
    ...
    /** @deprecated With boolean only, toggleClass as no behavior. Use with class name or func. */
    ...
    ********/
    ...
    /******
     EVENTS
    *******/
   /** @deprecated Rewrite your event to use the supported 'on/off' methods. */
