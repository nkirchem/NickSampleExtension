...
declare namespace HubsExtension {
    ...
    namespace DeploymentDetailsMenuBlade {
        ...
        interface Parameters {
            ...
            /**
             * The fully-qualified ID of the asset associated with the deployment. In the format <ExtensionName>_<AssetName>.
             */
    ...
    /**
     * Declarations for the GptGeneratorBlade.
     */
    namespace GptGeneratorBlade {
        /**
         * The inputs to the blade.
         */
        interface Parameters {
             ...
             * The infobox message.
             */
            readonly infoBoxMessage: string;

            /**
             * The placeholder text for the infobox.
             */
            readonly placeholderText: string;

            /**
             * The generate button text.
             */
            ...
            /**
             * The action to call on the generated API.
             */
    ...
    /**
     * Declarations for the ResourcePicker blade.
     */
    namespace ResourcePicker {
        ...
        interface FilterConfiguration {
             ...
             */
            readonly preselectedValues?: ReadonlyArray<string>;
        ...
        export interface Parameters {
             ...
             */
            readonly infoBoxContent?: string | HtmlContent;
             ...
             */
            readonly preselectedResourceIds?: ReadonlyArray<string>;
        ...
        /**
         * Resource Picker blade results.
         */
        export interface Results {
            /**
             * Selected resource ids. Undefined when user clicks on "cancel".
             */
    ...
    namespace BrowseQuery {
        ...
        export interface Parameters {
            ...
            /**
             * The flag to indicate the resource type supports edge zones.
             */
            readonly supportsEdgeZone: boolean;
        }
    }
    ...
    namespace ArgQueryBlade {
         ...
         * The query scope.
         */
        export interface PersistedQueryScope {
            /**
             * The scope of the query.
             */
            readonly scope: HubsExtension.ArgQueryBlade.QueryScope;
        ...
        export interface Parameters {
             ...
             */
            readonly queryScope?: PersistedQueryScope;
        }
    }

    namespace ArgEditPinnedQueryBlade {
        ...
        export interface Parameters {
            ...
            */
             ...
             * The scope of the query.
             */
            readonly queryScope?: HubsExtension.ArgQueryBlade.PersistedQueryScope;
        }

        /**
         * The data returned by the blade.
         */
    ...
    namespace InProductFeedbackBlade {
        ...
        export interface Parameters {
             ...
             */
            readonly disableInfobox?: boolean;
